...
export interface WhatsAppConfig {
  ...
  /** Active WhatsApp provider: 'meta' | 'mbowazap' (Migration 043) */
  provider?: 'meta' | 'mbowazap';
  mbowazap_session?: string | null;
  mbowazap_pairing_ref?: string | null;
  mbowazap_state?: 'pairing' | 'connected' | 'disconnected' | 'logged_out' | null;
  mbowazap_display_name?: string | null;
  mbowazap_brain?: 'tchuekbot' | 'wacrm';
  mbowazap_last_event_at?: string | null;
}
