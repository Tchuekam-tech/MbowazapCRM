  ...
  return (
    <section className="animate-in fade-in-50 duration-200">
      ...
      <div className="space-y-6">
        {/* MboWazap active provider banner */}
        {(config?.provider === 'mbowazap' || statusMessage.includes('MboWazap')) && (
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <AlertTitle className="text-foreground font-semibold mb-1">
                  Connected via MboWazap (TchuekBot)
                </AlertTitle>
                <AlertDescription className="text-muted-foreground text-sm">
                  This workspace is connected through the MboWazap Baileys gateway. To manage the companion number, switch AI brain modes, or disconnect, use the MboWazap settings panel.
                </AlertDescription>
                <div className="mt-3">
                  <Button
                    variant="outline"
                    ...
                    onClick={() => {
                      ...
                      params.set('tab', 'mbowazap');
                      window.history.pushState(null, '', `?${params.toString()}`);
                      window.location.reload();
                    }}
                  >
                    Go to MboWazap Settings →
                  </Button>
                </div>
              </div>
            </div>
